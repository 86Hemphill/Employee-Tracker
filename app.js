      ...
      .prompt([
        {
          type: "list",
          message:
            "What would you like to do? (Press 'CTRL'+'C' at any time to exit)",
          name: "startWhat",
          choices: [
...
function allRoles() {
  connection.query(
    "SELECT r.title, r.salary, d.name FROM role r JOIN department d ON r.department_id = d.id;",
    function (err, res) {
      if (err) throw err;
      console.table(res);
      start();
...
function allEmployees() {
  connection.query(
    "SELECT e.first_name, e.last_name, r.title, r.salary, d.name AS department FROM employee AS e JOIN role AS r ON e.role_id = r.id JOIN department AS d ON r.department_id = d.id;",
    "SELECT e.first_name, e.last_name, r.title, r.salary FROM employee e JOIN role r ON e.role_id = r.id;",
    function (err, res) {
      if (err) {
        throw err;
      };
...
function empManager() {
  ...
  function (err, res) {
    ...
    inquirer
      ...
      .then(function (answer) {
        connection.query(
          `SELECT ${answer.emp} FROM employee e LEFT JOIN e.first_name, e.last_name ON e.manager_id = e.id;`,
          function (err) {
            if (err) throw err;
            start();
          }
...
function updateManager() {
  connection.query("SELECT id, first_name, last_name FROM employee;", function (
    ...
    inquirer
      ...
      .then(function (answer) {
        connection.query(
          `UPDATE employee SET manager_id = ${answer.manager} WHERE id = ${answer.name};`,
          function (err) {
            if (err) throw err;
      ...
      .prompt([
        {
          ...
          type: "input",
          message:
            "Input the ID of the department that you would like to delete. (Warning: This will perform the delete)",
        },
      ])
      .then(function (answer) {
        connection.query(
      ...
      .prompt([
        {
          ...
          type: "input",
          message:
            "Input the ID of the role that you would like to delete. (Warning: This will perform the delete)",
        },
      ])
      .then(function (answer) {
        connection.query(
      ...
      .prompt([
        {
          ...
          type: "input",
          message:
            "Input the ID of the employee that you would like to delete. (Warning: This will perform the delete)",
        },
      ])
      .then(function (answer) {
        connection.query(
